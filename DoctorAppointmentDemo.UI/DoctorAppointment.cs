...
public class DoctorAppointment
{
    ...
    public DoctorAppointment(ISerialization serializer)
    {
        _doctorService = new DoctorService(serializer);
        _appointmentService = new AppointmentService(serializer);
        _patientService = new PatientService(serializer);
    }
